...
namespace IgorTime.BurstedFlowField
{
    ...
    public static class GridUtils
    {
        public static int GetCellIndex(in int2 gridSize, in int2 cellCoordinates) =>
            GetCellIndex(gridSize, cellCoordinates.x, cellCoordinates.y);

        public static int GetCellIndex(in int2 gridSize, in int x, in int y) => x + y * gridSize.x;
        ...
        public static bool IsCellInGrid(in int2 gridSize, in int2 cellCoordinates) =>
            math.all(cellCoordinates >= 0) && math.all(cellCoordinates < gridSize);
